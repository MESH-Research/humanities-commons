...
class SparkPostHTTPMailer extends PHPMailer
{
    ...
    /**
	 * Validate email addresses according to the html5 standard.
	 *
	 * The default PHP email validator rejects reply-to email addresses
	 * generated by bp-reply-by-email for discussion posts because the email
	 * addresses are too long. This function uses the html5 standard as default
	 * instead, which accepts those email addresses.
	 *
	 * @see PHPMailer::validateAddress
	 * @see BP_Reply_By_Email::get_reply_to_address
	 *
	 * @author Mike Thicke
	 *
