...
if ( class_exists('BP_Group_Extension') ) : // Recommended, to prevent problems during upgrade or when Groups are disabled
    ...
    class BP_Group_Documents_Plugin_Extension extends BP_Group_Extension {
                            ...
                            foreach ( $group_categories as $category ) {
                                if ( isset($_GET['edit']) && ( $_GET['edit'] == $category->term_id ) ) {
                                    ...
                                    <li id="category-<?php echo $category->term_id; ?>"><?php echo $category->name; ?>
                                        <div>&nbsp; <a class="group-documents-category-edit button" href="<?php echo $edit_link; ?>"><?php _e('Edit' , 'bp-group-documents'); ?></a>
                                            <a class="group-documents-category-delete button" href="<?php echo $delete_link; ?>"><?php _e('Delete' , 'bp-group-documents'); ?></a></div>
                                    </li>
                                    <?php
                                }
                            }
        ...
        function edit_create_markup($gid) {
            ...
            ?>
            <div><label><?php _e('Upload Permissions:' , 'bp-group-documents'); ?></label></div>
            <p>
                <?php
