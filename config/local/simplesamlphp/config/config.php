...
$config = [
     ...
     * reverse proxy).
     */
    'baseurlpath' => 'https://commons-wordpress.lndo.site/simplesaml',
     ...
     * root directory.
     */
    'certdir' => '/app/config/local/simplesamlphp/cert/',
    'loggingdir' => '/app/config/local/simplesamlphp/log/',
    'datadir' => '/app/config/local/simplesamlphp/data/',
    'tempdir' => '/app/config/local/simplesamlphp/tmp/',
     ...
     */
    'session.datastore.timeout' => 1209600,

    /*
     * Sets the duration, in seconds, auth state should be stored.
     */
    'session.state.timeout' => 1209600,

    /*
     * Option to override the default settings for the session cookie name
     */
    'session.cookie.name' => 'SimpleSAMLSessionIDCommons',
     ...
     */
    'session.cookie.lifetime' => 1209600,
     ...
     */
    'session.phpsession.cookiename' => 'SimpleSAMLCommons',
    ...
    'authproc.sp' => [
        ...
        */
        ...
        60 => [
            ...
            'urn:oid:2.16.840.1.113730.3.1.241' => 'IDP_DISPLAYNAME',
            'urn:oid:0.9.2342.19200300.100.1.3' => 'IDP_MAIL',
            'urn:oid:1.3.6.1.4.1.5923.1.1.1.6'  => 'IDP_UID',
            'urn:oid:2.5.4.42'                  => 'givenName',
            'urn:oid:1.3.6.1.4.1.49574.110.12'  => 'idpOrgName',
            'urn:oid:1.3.6.1.4.1.49574.110.10'  => 'idpDisplayName',
            'urn:oid:2.16.840.1.113730.3.1.3'   => 'employeeNumber',
            'urn:oid:0.9.2342.19200300.100.1.3' => 'mail',
            'urn:oid:2.5.4.10'                  => 'o',
            'urn:oid:1.3.6.1.4.1.49574.110.11'  => 'idpOrgDisplayName',
            'urn:oid:2.5.4.12'                  => 'title',
            'urn:oid:1.3.6.1.4.1.49574.110.13'  => 'idpEntityId',
            'urn:oid:0.9.2342.19200300.100.1.1' => 'uid',
            'urn:oid:1.3.6.1.4.1.5923.1.5.1.1'  => 'isMemberOf',
            'urn:oid:2.5.4.4'                   => 'sn',
            'urn:oid:1.3.6.1.4.1.49574.110.20.1' => 'mlaid',
        ],

       // Scott's IDP metadata attribute module.
       70 => [
            'class' => 'idpsamlmdattributes:AttributeFromMetadata',
            'DisplayName' => 'Meta-displayName',
            'OrganizationName' => 'Meta-organizationName',
            'OrganizationDisplayName' => 'Meta-organizationDisplayName'
        ],
     ...
     */
    'metadatadir' => '/app/config/local/simplesamlphp/metadata',
